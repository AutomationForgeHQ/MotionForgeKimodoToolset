...
public:
	...
	UKimodoSkill()
	{
		...
		Instructions = TEXT(
			...
			"else.\n"
			"\n"
			"Do not rebuild the container as a general remedy. It is the fix for exactly two things: "
			"a clip that fails to read with a version or joint-count mismatch, and a runner that "
			"answers while reporting Kimodo as not importable.\n"
			"\n"
